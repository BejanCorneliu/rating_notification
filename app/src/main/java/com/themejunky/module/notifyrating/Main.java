...
public class Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                new Module_NotifyRating(Main.this,Main.class,"com.keyboard").set_TextAndIcon("Title","Subtite",R.drawable.app_logo).set_DebugMode(true).set_HoursAndRepeateTimes(120000,4,30000).start();
            }
        }).start();
